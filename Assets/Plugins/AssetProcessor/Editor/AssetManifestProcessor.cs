...
public class AssetManifestProcessor : UnityEditor.AssetModificationProcessor
{
    ...
    static AssetManifest s_AssetManifest;
    public static AssetManifest GetAssetManifest()
    {
        if (s_AssetManifest == null)
            s_AssetManifest = AssetDatabase.LoadAssetAtPath<AssetManifest>(AssetManifest.s_AssetManifestPath);

        if (s_AssetManifest == null)
        {
            s_AssetManifest = ScriptableObject.CreateInstance<AssetManifest>();
            AssetDatabase.CreateAsset(s_AssetManifest, AssetManifest.s_AssetManifestPath);
        }
    ...
    {
        AssetManifest manifest = GetAssetManifest();
    ...
    static bool IsIgnore(string assetPath, AssetManifest manifest)
    {
